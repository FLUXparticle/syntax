...
public class ParserRuntimeException extends RuntimeException {
    ...
    public ParserRuntimeException(String message, Throwable cause, String input, int pos) {
        super(message, cause);
        this.input = input;
        this.pos = pos;
    }

    public ParserRuntimeException(Set<LexerElement> expected, LexerElement actual, String input, int pos) {
